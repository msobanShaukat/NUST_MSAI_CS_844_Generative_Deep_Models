...
[![Course](https://img.shields.io/badge/Course-CS%20844%20Generative%20Deep%20Models-1E90FF?style=for-the-badge&logo=bookstack&logoColor=white)](#)
[![Institution](https://img.shields.io/badge/NUST-CEME-006400?style=for-the-badge&logo=academia&logoColor=white)](https://www.nust.edu.pk)
[![Department](https://img.shields.io/badge/Department-Computer%20Engineering-483D8B?style=for-the-badge)](#)
[![Level](https://img.shields.io/badge/Level-Postgraduate-DC143C?style=for-the-badge&logo=graduation-cap&logoColor=white)](#)
[![Course_Type](https://img.shields.io/badge/Course%20Type-Core-8B0000?style=for-the-badge)](#)

<br/>

[![Python](https://img.shields.io/badge/Python-3.9%2B-3776AB?style=flat-square&logo=python&logoColor=white)](https://www.python.org/)
[![PyTorch](https://img.shields.io/badge/PyTorch-2.x-EE4C2C?style=flat-square&logo=pytorch&logoColor=white)](https://pytorch.org/)
[![JAX](https://img.shields.io/badge/JAX-ML-000000?style=flat-square)](https://github.com/google/jax)
[![Jupyter](https://img.shields.io/badge/Jupyter-Notebook-F37626?style=flat-square&logo=jupyter&logoColor=white)](https://jupyter.org/)
[![ML](https://img.shields.io/badge/Focus-Deep%20Generative%20Models-663399?style=flat-square)](#)
[![LLMs](https://img.shields.io/badge/Includes-Large%20Language%20Models-412991?style=flat-square&logo=openai&logoColor=white)](#)
...
- [ℹ️ Course Information](#ℹ️-course-information)
...
> As per the CS-844 Generative Deep Models course outline, Department of Computer Engineering, CEME — NUST  .

| Field | Details |
|---|---|
| 📘 **Course Number** | CS-844 |
| 🏫 **Course Title** | Generative Deep Models |
| 🎓 **Credits** | (as specified in official outline)   |
| 👩‍🏫 **Instructor(s)-in-charge** | As per department allocation   |
| 🏛️ **Department** | Computer Engineering, CEME — NUST   |
| 🎯 **Course Type** | Core / Elective (as in outline)   |
| 📚 **Prerequisites** | Basic probability, calculus, and Python   |
| 🎓 **Degree & Semester** | Postgraduate (PG)   |
| 📅 **Academic Year** | As mentioned in the official course outline   |
...
| Component | Details |
|---|---|
| 🕐 **Lectures** | Weekly lecture-based delivery (3 hrs/week typical PG pattern)   |
| 🔬 **Lab** | As specified in the official outline (lab / no-lab)   |
| 💬 **Discussion** | Discussion/tutorial hours as allocated by the instructor   |
| 📖 **Outside Study** | Independent study and project work as recommended   |
...
The following structure mirrors the “Week / Lecture Title / Topics” table in your course outline  .
...
|---|---|
| 🧪 **Exam(s)** | Midterm / final exam(s) covering theoretical and applied aspects of generative models  . |
| 📝 **Homework** | Written and coding assignments on topics like VAEs, GANs, diffusion, etc.  . |
| 🧪 **Lab / Design Reports** | Reports linked to implementation projects or experiments with generative models  . |
| 📄 **Design Report** | A conceptual or empirical project report focused on a selected generative model or application  . |
| 🗒️ **Quizzes** | Short quizzes to regularly assess understanding of core concepts  . |
| 👥 **Class Participation** | Active participation in discussions, presentations, and code reviews  . |
